...
const EXECUTION_FAILURE_MESSAGES: Record<ExecutionFailReason, FailureMessage> =
  {
    all_investigations_failed: {
      ...
      guidance:
        "調査を完了できませんでした。各エージェントの失敗理由を確認のうえ、テンプレート一覧から再度お試しください。",
    },
    integration_failed: {
      label: "統合エージェントが失敗しました",
      guidance:
        "調査結果の統合に失敗しました。調査エージェントの出力を確認のうえ、テンプレート一覧から再度お試しください。",
    },
    timeout: {
      label: "実行がタイムアウトしました",
      guidance:
        "実行全体が時間内に完了しませんでした。時間をおいてからテンプレート一覧で再度お試しください。",
    },
    internal_error: {
      label: "内部エラーが発生しました",
      guidance:
        "予期しないエラーが発生しました。時間をおいてからテンプレート一覧で再度お試しください。",
    },
  };
