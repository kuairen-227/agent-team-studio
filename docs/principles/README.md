...
| ISTQB / TDD・BDD（軽量）/ Testing Trophy（Web 層） | 横断（テスト原則）/ qa（領域固有） | [testing.md](./testing.md), [.claude/agents/qa.md](../../.claude/agents/qa.md), [ADR-0010](../adr/0010-development-workflow.md), [ADR-0036](../adr/0036-web-layer-testing-trophy.md) |
