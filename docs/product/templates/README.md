...
- 対応する I/O スキーマは `docs/design/templates/<template-id>.md` に配置する。I/O スキーマの SSoT は design/ 側のため、本ディレクトリ **から** design/ への片方向参照で接続する（[ADR-0021](../../adr/0021-doc-cross-reference-policy.md)）
