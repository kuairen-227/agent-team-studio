...
- **進捗を隠さない**: 何が動いているかをリアルタイムに可視化する（[ui-patterns.md §1.1](../design/ui-patterns.md)）
- **失敗を隠さない**: partial-failure を通常状態と同等に並べる（[ui-patterns.md §1.2](../design/ui-patterns.md), [agent-execution.md §6](../design/agent-execution.md)）
...
- カスタムカラーはステータスバッジの 4 色のみ（[ui-patterns.md §5.2](../design/ui-patterns.md)）
