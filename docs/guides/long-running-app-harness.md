...
採点基準・スコア尺度・hard threshold・few-shot 較正例の本体は [.claude/agents/evaluator.md](../../.claude/agents/evaluator.md) を SSoT とする。要点:
...
| **しきい値を下回り続ける / 収束しない** | 人手へエスカレーション（§4 の暴走・無限ループ緩和） | 同上 |
