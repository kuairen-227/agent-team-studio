...
- 対応するプロダクト視点の仕様は `docs/product/templates/<template-id>.md` に配置する。本ディレクトリが I/O スキーマの SSoT のため、`docs/product/templates/` 側 **から** 本ディレクトリへの片方向参照で接続する（[ADR-0021](../../adr/0021-doc-cross-reference-policy.md)）
