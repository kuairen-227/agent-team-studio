...
| [0037](./0037-ai-execution-sandbox-policy.md) | AI 実行のサンドボックス方針（Bash サンドボックス見送り・DevContainer egress allowlist 採用） | accepted | 2026-06-08 |
...
| [0040](./0040-defer-secret-at-rest-encryption.md) | シークレット at-rest 暗号化の見送りと残存リスクの運用統制による受容（ADR-0039 一部再評価） | proposed | 2026-06-14 |
