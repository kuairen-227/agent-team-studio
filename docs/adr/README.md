...
| [0044](./0044-v2-scope-definition.md) | v2.0 機能拡張のスコープ定義（基準3 決着 + UC#2 / フェーズ制 + Go/No-Go） | accepted（v2.1 割当は 0046 で一部再評価） | 2026-06-26 |
| [0045](./0045-web-search-api-selection.md) | Web 検索 API の選定（専用 API 方式 + Tavily 採用 / 出典グラウンディング） | accepted | 2026-06-27 |
| [0046](./0046-minor-version-milestone-generalization.md) | vN.x マイルストーンの一般化と v2.1 のデザイン質感改善への割当（ADR-0031 拡張） | accepted | 2026-06-27 |
