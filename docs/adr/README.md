...
| [0016](./0016-devcontainer-integration.md) | DevContainer の統合構成（compose + features + 認証共有 volume） | accepted（一部 superseded by 0017） | 2026-04-29 |
| [0017](./0017-relocate-compose-and-consolidate-env.md) | docker-compose / Dockerfile をリポジトリルートに配置し、env を部品方式に統合する | accepted | 2026-05-01 |
