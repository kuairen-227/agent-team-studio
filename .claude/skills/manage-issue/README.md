...
- **単発 Issue 1 件のみ・親子なし** → [`/create-issue`](../create-issue/SKILL.md) を使う
- 特定 Issue を読んで作業計画＋実装まで進める → [`/process-issue`](../process-issue/SKILL.md)
- 開発環境モード (solo/nested/split) の判断 → [`/judge-dev-mode`](../judge-dev-mode/SKILL.md)
