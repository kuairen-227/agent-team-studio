...
context: fork
agent: pm
allowed-tools: Bash(gh issue list:*) Bash(gh issue view:*) Bash(gh issue create:*) Bash(gh issue edit:*) Bash(gh issue comment:*) Bash(gh milestone list:*) Bash(gh api:*) Bash(git log:*) Read Grep Glob
---
...
- **(b) 親先・後で更新**：親 Issue を「子 Issue（後続で追記）」プレースホルダで起票し、子起票後に `gh issue edit <parent>` で本文を更新
