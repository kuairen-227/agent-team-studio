...
context: fork
agent: pm
allowed-tools: Bash(gh issue list:*) Bash(gh issue view:*) Bash(gh issue create:*) Bash(gh issue edit:*) Bash(gh issue comment:*) Bash(gh issue close:*) Bash(gh milestone list:*) Bash(gh api repos/:owner/:repo/issues:*) Bash(gh api -X POST repos/:owner/:repo/issues:*) Bash(gh api repos/:owner/:repo/milestones:*) Bash(gh api -X PATCH repos/:owner/:repo/milestones:*) Bash(git log:*) Read Grep Glob
---
