...
allowed-tools: Bash(gh issue view:*) Bash(gh issue list:*) Bash(gh issue comment:*) Bash(gh api:*) Bash(git checkout:*) Bash(git switch:*) Bash(git branch:*) Bash(npm:*) Bash(npx:*) Read Grep Glob Edit Write Agent Skill
---
