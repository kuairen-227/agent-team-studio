...
allowed-tools: Bash(gh issue view:*) Bash(gh issue list:*) Bash(gh issue comment:*) Bash(git checkout:*) Bash(git switch:*) Bash(git branch:*) Bash(git add:*) Bash(git commit:*) Bash(git status:*) Bash(git diff:*) Bash(git log:*) Bash(bun run:*) Read Grep Glob Edit Write Agent Skill(implement-feature)
---
