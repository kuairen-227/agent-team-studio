...
context: fork
agent: pm
allowed-tools: Bash(gh issue list:*) Bash(gh issue view:*) Bash(gh milestone list:*) Bash(git log:*) Read Grep Glob
---
...
横断軸（判断はユーザーに委ねる・過剰な管理を避ける等）は [設計・開発原則](../../../docs/principles/README.md) を参照。勝手に Issue の変更（ラベル付与、クローズ等）を行わない。
